(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ethers'), require('@walletconnect/web3-provider')) :
    typeof define === 'function' && define.amd ? define(['exports', 'ethers', '@walletconnect/web3-provider'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Auth = {}, global.ethers, global.WalletConnectProvider));
})(this, (function (exports, ethers$1, WalletConnectProvider) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Metamask = /** @class */ (function () {
        ...
        Metamask.prototype._initMM = function () {
            ...
            if (ethereum != undefined) {
                this._provider = new ethers$1.ethers.providers.Web3Provider(ethereum);
            }
            else if (web3 != undefined) {
                this._provider = new ethers$1.ethers.providers.Web3Provider(web3.currentProvider);
            }
            else {
    ...
    var WalletConnect = /** @class */ (function () {
        ...
        WalletConnect.prototype._initWC = function () {
            ...
            this._web3Provider = new ethers$1.ethers.providers.Web3Provider(this._provider);
        };
    ...
    function useContract(contractAddress, abi, provider) {
        var contract = new ethers$1.ethers.Contract(contractAddress, abi, provider);
        return contract;
    }
    var useMetamask = Metamask;
    var useWalletConnect = WalletConnect;
    var ethers = ethers$1.ethers;
